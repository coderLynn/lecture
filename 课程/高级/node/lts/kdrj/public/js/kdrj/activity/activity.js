Fengs.add('kdrj/activity/activity', function(S, $,Req, cookie, md5, popBox) {
...
/*                        dt.click(function() {
    ...
    var index = {
        ...
        _addClass: function() {
            // 0
            $(".flex-control-nav li").eq(0).hover(
                function() {
                    $(".flex-control-nav li").eq(0).addClass("hvr");
                    // $(".flex-control-nav li").eq(1).addClass("hvr2").siblings().removeClass("hvr2");
                },function() {
                    $(".flex-control-nav li").eq(0).removeClass("hvr");
                    // $(".flex-control-nav li").eq(1).removeClass("hvr2").siblings().addClass("hvr2");
                }
            );
            $(".flex-control-nav li").eq(1).hover(
                function() {
                    $(".flex-control-nav li").eq(1).addClass("hvr2");
                },function() {
                    $(".flex-control-nav li").eq(1).removeClass("hvr2");
                }
            );
            $(".flex-control-nav li").eq(2).hover(
                function() {
                    $(".flex-control-nav li").eq(2).addClass("hvr3");
                },function() {
                    $(".flex-control-nav li").eq(2).removeClass("hvr3");
                }
            );
